#
#  Be sure to run `pod spec lint PickerField.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "mohamedmernissi" => "contact@mohamedmernissi.com" }
  # Or just: spec.author    = "mmernissi"
  # spec.authors            = { "mohamedmernissi" => "contact@mohamedmernissi.com" }
  spec.social_media_url   = "http://mohamedmernissi.com"
  ...
  spec.source_files  = "PickerField/**/*.{h,m,swift}"
